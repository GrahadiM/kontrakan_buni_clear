                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <a href="{{ route('keluhan.index') }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-search fa-fw"></i> VIEW LIST LAPORAN
                                    </a>
                                    {{-- <a href="{{ route('keluhan.edit', $laporan->id) }}" class="btn btn-primary btn-sm">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="string" id="TanggalLaporan" class="form-control" value="{{ $laporan->created_at }}">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="body" class="form-control summernote">{!! $laporan->keluhan !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
