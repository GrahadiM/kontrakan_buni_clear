                        ...
                        <div class="col-lg">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <a href="{{ route('kontrakan.index') }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-search fa-fw"></i> VIEW LIST KONTRAKAN
                                    </a>
                                    <a href="{{ route('kontrakan.show', $sewa->id) }}" class="btn btn-primary btn-sm">
                                        <i class="fas fa-search fa-fw"></i> DETAIL
                                    </a>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('kontrakan.update', $sewa->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                        <div class="row">
                                            <div class="col-lg-4">
