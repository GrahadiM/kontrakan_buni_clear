...
@section('content_title','Create Transaksi')
@section('content')
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="sewa_id" required="" id="sewa_id" class="custom-select">
                                                        <option disabled selected>Pilih Penyewa sesuai Nama dan Kamar</option>
                                                        @foreach ($sewas as $sewa)
                                                            @if ($sewa->user->role == 'penyewa')
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="tahun" required="" id="tahun" class="form-control" value="{{ date('Y') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="body">Catatan :</label>
                                                    <textarea name="note" required="" id="body" class="form-control summernote">{{ __('<p><b>Jangan lupa bayar kontrakan bulan ini!!</b><br></p>') }}</textarea>
                                                </div>
